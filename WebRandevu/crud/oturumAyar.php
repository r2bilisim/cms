...
<div class="col-sm-4">
			...
			<h4><strong><?php echo $row_GrupAdi['GRUP_ISMI']; ?></strong> <?php echo $diller['oturumSuresi']; ?></h4>
			</div>
			<div class="panel-body table-responsive">
			<form method="post" name="oturumSuresiForm" action="WebRandevu/crud/guncelle.php?guncelle">
			<table class="table table-hover">
				<tr>
					<td><?php echo $diller['oturumSuresi']; ?>(<?php echo $diller['dakika']; ?>):</td>
				...
				<tr>				
					...
					<button name="oturumDurumBtn" class="btn btn-primary form-control"><?php echo $diller['guncelle']; ?></button>
					</td>
				</tr>
			</table>
			</form>
		 ...
		 <?php echo $diller['oturumSuresi']," ",$diller['guncelle']; ?>
		  </div>
        </div>
		</div>
<?php } else{ ?>
<div class="col-sm-4 col-md-4">
			...
			<table class="table table-hover">
				...
				<tr>				
					<td colspan="2" style="padding:5px">
					<input type="hidden" name="GRPID" value="<?php echo $GRPID; ?>" />
					<button name="oturumDurumBtn" class="btn btn-success form-control"><?php echo $diller["kaydet"];?></button>
					</td>
				</tr>
			</table>
			</form>
		  ...
		  <div class="panel-footer">
		 <?php echo $diller['oturumSuresi']," ",$diller['kaydet']; ?>
		  </div>
        </div>
		</div>
...
<?php } ?>
		...
		<div class="col-sm-4 col-md-4">
			<div class="panel panel-info">
				<div class="panel-heading">
				<h4><i class="glyphicon glyphicon-info-sign"></i><strong><?php echo $row_GrupAdi['GRUP_ISMI']; ?></strong> <?php echo $diller['oturumSuresi']," ",$diller['onizleme']; ?></h4>           
				</div>
...
<div><?php echo $diller['kalanSure']; ?> <div class="clock"></div></div>
