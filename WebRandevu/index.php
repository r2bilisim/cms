...
$(document).ready(function() {
 ...
 <div class="row">  
	  ...
	  <?php if(isset($_GET['mail'])){ ?>
	    ...
	    <?php include("crud/grupSecici.php"); ?>
		<?php include("crud/epostaAyar.php"); ?><!-- epostaAyar(web randevu için bilgilendirme epostası için) ekle -->

	  <?php }?>
	  	  <?php if(isset($_GET['sms'])){ ?>
  
	    <?php include("crud/grupSecici.php"); ?>
		<?php include("crud/smsApiAyar.php"); ?><!-- smsApiAyar(web randevu için bilgilendirme sms'i için) ekle -->
