...
if($_POST['DoubleClick']=="on"){ $DoubleClick=true;}else{ $DoubleClick=false;}                                
  ...
  $insertGoTo = "?TerminalEkle&durum=ekle&";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title alert alert-danger">Omes</h4>
        </div>
        <div class="modal-body">
          <p><strong>#<?php echo $_GET["hata"]; ?> <?php echo $diller['terminalHatasi']; ?></strong></p>
        </div>
...
<div class="form-group">
  ...
  <div class="panel panel-heading">1-<?php echo $diller['terminalGirisEkrani']; ?></div><div class="panel body table-responsive">
  <table class="table table-hover">
    ...
    <tr valign="baseline">
      ...
      <td><span id="sprytextfield2"><input class="form-control" type="text" name="TERMINAL_AD" value="" size="32" maxlength="20" placeholder="<?php echo $diller['terminalAdi']; ?>">
        <span class="textfieldRequiredMsg"><?php echo $diller['bosgecilemez']; ?></span></span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><select class="form-control" name="TerminalTipi">
        <option value="Oda" <?php if (!(strcmp("Oda", ""))) {echo "SELECTED";} ?>><?php echo $diller['oda']; ?></option>
        <option value="Poliklinik" <?php if (!(strcmp("Poliklinik", ""))) {echo "SELECTED";} ?>><?php echo $diller['poliklinik']; ?></option>
        <option value="Masa" <?php if (!(strcmp("Masa", ""))) {echo "SELECTED";} ?>><?php echo $diller['masa']; ?></option>
        <option value="Vezne" <?php if (!(strcmp("Vezne", ""))) {echo "SELECTED";} ?>><?php echo $diller['vezne']; ?></option>
        <option value="Banko" <?php if (!(strcmp("Banko", ""))) {echo "SELECTED";} ?>><?php echo $diller['banko']; ?></option>
        <option value="Ünite" <?php if (!(strcmp("Ünite", ""))) {echo "SELECTED";} ?>><?php echo $diller['unite']; ?></option>
        </select></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><select class="form-control" name="SiralamaTipi">
        <option value="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>><?php echo $diller['alinmaSirasi']; ?></option>
        <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>><?php echo $diller['biletNo']; ?></option>
      </select></td>
    </tr>
    <tr valign="baseline">
      <td nowrap><?php echo $diller['cagriTipi']; ?>:</td>
      <td><select class="form-control" name="CagriSiralamaTipi">       
        <option value="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>><?php echo $diller['oran']; ?></option>
        <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>><?php echo $diller['kuyruk']; ?></option>
      </select></td>
    </tr>
    <tr valign="baseline">
