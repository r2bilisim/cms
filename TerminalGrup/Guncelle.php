<?php 
	...
	if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
		...
		I_YF3=:I_YF3, B_YF=:B_YF, AYRICALIKLI=:AYRICALIKLI, webrandevu=:webrandevu WHERE TGID=:TGID");
		...
		$updateSQL->bindParam(':webrandevu', $webrandevu);
		if($_POST['webrandevu']=="on"){ $webrandevu=true;}else{ $webrandevu=false;}
		$updateSQL->bindParam(':TGID', $_POST['TGID']);
		$updateSQL->execute();
		
		
		$updateGoTo = "?TerminalGrupListele=".$_POST["TID"]."&durum=gnc&";
		if (isset($_SERVER['QUERY_STRING'])) {
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
	<div class="form-group">
		<div class="panel panel-blue">
			<div class="panel panel-heading"><?php echo $diller['terminalGrupGuncelle']; ?></div>
			<div class="panel body table-responsive">
				<table class="table table-hover table-bordered" align="center">
					<tr valign="baseline">
						<td nowrap align="right"><?php echo $diller['terminalAdi']; ?>:</td>
						<td>
							<?php
						...
						<tr valign="baseline">
							<td nowrap align="right"><?php echo $diller['grupIsmi']; ?>:</td>
							...
							<tr valign="baseline">
								<td nowrap align="right"><?php echo $diller['cagriOrani']; ?>:</td>
							...
							<tr valign="baseline">
								<td nowrap align="right"><?php echo $diller['transferOrani']; ?>:</td>
							...
							<tr valign="baseline">
								<td nowrap align="right"><?php echo $diller['yardimGrubu']; ?>:</td>
								<td><label class="switch"><input type="checkbox" name="YARDIM_GRUBU" <?php if($row_terminal_grup['YARDIM_GRUBU']==1){ echo "checked"; }  ?>><span class="slider round"></span></label></td>
							</tr>
							<tr valign="baseline">
								<td nowrap align="right"><?php echo $diller['oncelik']; ?>:</td>
							...
							<tr valign="baseline">
								<td nowrap align="right"><?php echo $diller['ayricalikli']; ?>:</td>
								<td><label class="switch"><input type="checkbox" name="AYRICALIKLI" <?php if($row_terminal_grup['AYRICALIKLI']==1){ echo "checked"; } ?>><span class="slider round"></span></label></td>
							</tr>
							<tr valign="baseline">
								<td nowrap align="right"><?php echo $diller['webRandevu']; ?>:</td>
								<td><label class="switch"><input type="checkbox" name="webrandevu" <?php if($row_terminal_grup['webrandevu']==1){ echo "checked"; } ?>><span class="slider round"></span></label></td>
							</tr>
							<tr valign="baseline">
								<td nowrap align="right"><input type="hidden" name="CAGRILAN" value="<?php echo htmlentities($row_terminal_grup['CAGRILAN'], ENT_COMPAT, 'utf-8'); ?>" size="32">   
								<input type="hidden" name="TRANSFER_CAGRILAN" value="<?php echo htmlentities($row_terminal_grup['TRANSFER_CAGRILAN'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
								<td><input class="form-control btn btn-primary" type="submit" value="<?php echo $diller['guncelle']; ?>"></td>
							</tr>
						</table>
					</div>
				</div>
