<?php
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formTerminalGrup")) {
		...
		TRANSFER_CAGRILAN, ONCELIK, S_YF1, S_YF2, S_YF3, I_YF1, I_YF2, I_YF3, B_YF, AYRICALIKLI, webrandevu) 
		...
		$insertSQL->bindParam(':webrandevu', $webrandevu);
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p><strong>#<?php echo $_GET["TID"]; ?>. Terminal <?php echo $diller['ve'];?> #<?php echo $_GET["GRPID"]; ?>.<?php echo $diller['terminalGrupEslesmeHatasi']; ?></strong></p>
				</div>
...
<form method="post" name="formTerminalGrup" action="<?php echo $editFormAction; ?>">
	<div class="form-group">
		<div class="panel panel-grey">
			<div class="panel panel-heading">2-<?php echo $diller['terminalGrupGiris']; ?></div>
					...
					<tr valign="baseline">
						...
						<tr valign="baseline">
							...
							<tr valign="baseline">
								...
								<td> <label class="switch"><input type="checkbox" name="webrandevu" value="">
								<span class="slider round"></span>  </label></td>
							</tr>
							<tr valign="baseline">
								<td nowrap align="right"><input type="hidden" name="CAGRILAN" value="0" size="32">       
								<input type="hidden" name="TRANSFER_CAGRILAN" value="0" size="32"></td>
								<td><input class="form-control btn btn-info" type="submit" value="<?php echo $diller['ekle']; ?>"></td>
							</tr>
						</table>
					</div>
				</div>
