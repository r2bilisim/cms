	...
	*/
	...
	if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
		...
		if((!empty($_FILES["RESIM"]) and $_FILES["RESIM"]["tmp_name"]!="") and ($_POST)){
			...
			FONT=:FONT, PUNTO=:PUNTO, Border_Style=:Border_Style, Border_Width=:Border_Width, Border_Color=:Border_Color, Border_Radius=:Border_Radius
...
<?php if(isset($_GET["AltButonGuncelle"]) and $_GET["AltButonGuncelle"]=="ok" )
    ...
    <div id="eklendi"><span class="btn btn-success"><?php echo $diller['guncellemeBasariliMesaj']; ?><a class="btn btn-red" href="?AltButonListele"><?php echo $diller['altbutonMesaj_3']; ?></a> <a class="btn btn-info" href="?AltButonEkle"><?php echo $diller['altbutonMesaj_4']; ?>.</a> </span></div>
	<?php
	}
?>
					...
					<div class="panel body table-responsive">    
						<table class="table table-hover">
							<tr valign="baseline">
								...
								<th align="right"><p><?php echo $diller['anabuton']; ?> ID
									<span id="spryselect2">
										<select class="form-control" name="ANA_BTNID" id="ANA_BTNID">
											<option value="-1" <?php if (!(strcmp(-1, $row_Butonlar['BTNID']))) {echo "selected=\"selected\"";} ?>><?php echo $diller['seciniz']; ?></option>
											<?php
									...
									<span class="selectInvalidMsg"><?php echo $diller['gecerlibirogesec']; ?></span><span class="selectRequiredMsg"><?php echo $diller['gecerlibirogesec']; ?></span></span> </p>
								</th>
