...
<div class="form-group">
	<div class="panel panel-grey">
		<div class="panel panel-heading"><?php echo $diller['anatabloYonGuncelle']; ?></div>
						...
						<tr valign="baseline">
							...
							<tr valign="baseline">
								...
								<td><select class="form-control" name="YON">
									<option value="1" <?php if (!(strcmp(1, htmlentities($row_AnaTabloYon['YON'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $diller['yukari']; ?></option>
									<option value="2" <?php if (!(strcmp(2, htmlentities($row_AnaTabloYon['YON'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $diller['asagi']; ?></option>
									<option value="3" <?php if (!(strcmp(3, htmlentities($row_AnaTabloYon['YON'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $diller['sag']; ?></option>
									<option value="4" <?php if (!(strcmp(4, htmlentities($row_AnaTabloYon['YON'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $diller['sol']; ?></option>
									<option value="5" <?php if (!(strcmp(5, htmlentities($row_AnaTabloYon['YON'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $diller['kapali']; ?></option>
								</select></td>
							</tr>
							<tr valign="baseline">
