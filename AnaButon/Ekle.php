<?php
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
		...
		RandevuButonuMu, GRP_ID2, GRP1_ORAN, GRP2_ORAN, GRP_ID3, GRP3_ORAN, GRP_ID4, GRP4_ORAN, FONT, PUNTO, Border_Style, Border_Width, Border_Color, Border_Radius ) 
		...
		$insertGoTo = "?AnaButonEkle=ok&ekle=ok";
		if (isset($_SERVER['QUERY_STRING'])) {
				...
				<div class="col-md-6">
					<div class="panel body table-responsive">
						<table class="table table-hover">
							<tr valign="baseline">
								<th nowrap align="right"><?php echo $diller['makineAdi']; ?></th>
								<td colspan="2"><span id="spryselect1">
									<select class="form-control btn btn-success" name="BM_ADRES">
										<option value="-1"><?php echo $diller['makineSec']; ?></option>
										<?php 
								...
								<th><?php echo $diller['buton']; ?> ID <input name="BTNID" type="number" class="form-control" max="1000" min="1" value="1" size="5"></th>
							</tr>
							<tr valign="baseline">
							...
							<tr valign="baseline">
								...
								<td colspan="2"><span id="spryselect2">
									<select class="form-control" name="GRP_ID">
										<option value="-1">1.<?php echo $diller['grupSec']; ?></option>
										<?php
					...
					<div class="panel body table-responsive">
						<table id="tableID" class="table table-hover">
							<tr valign="baseline">
								...
								<span id="countsprytextarea1">&nbsp;</span><span class="textareaMaxCharsMsg"><?php echo $diller['maxKarakter']; ?>(250)</span><span class="textareaMinCharsMsg">.</span></span></td>
							</tr>
							<tr valign="baseline">
...
<script type="text/javascript">
	...
	var sprytextarea2 = new Spry.Widget.ValidationTextarea("sprytextarea2", {maxChars:250, isRequired:false, counterId:"countsprytextarea2", hint:"<?php echo $diller['aciklama']; ?>", validateOn:["blur", "change"]});
</script>
</script>
