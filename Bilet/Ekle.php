...
<div id="SilOk" class="alert alert-danger"><strong><?php echo $diller['silindiMesaj']; ?></strong></div>
<?php
}
?>
<!-- Jquery ile fadein fadeout için -->
...
<div id="hata" class="alert alert-danger"><strong><?php echo $diller['gecerliBirBiletMakinesiSec']; ?></strong></div>
<?php
}
...
<div id="eklendi" class="btn btn-success"><?php echo "#".$_GET['?KioskSil']; ?> <?php echo $diller['silindiMesaj']; ?> <strong> <?php echo $diller['kioskSilmeNotu']; ?></strong></div>
<?php
}
?> <div class="panel-group">
  <div class="panel panel-grey">
  <div class="panel panel-heading"><?php echo $diller['biletYazdirmaAyarlari']; ?></div>
...
<form name="form" id="form">  
  <select class="form-control btn btn-warning" role="menu" name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenuGo('jumpMenu','parent',0)">
    <option value="?BiletEkle"><?php echo $diller["kioskBiletMakinesiSec"]; ?></option>
    <?php
...
?>
 ...
 <a href="?BiletSil=<?php if(isset($_GET['Kiosk'])){echo $_GET['Kiosk'];} ?>" class="form-control btn btn-danger" id="sprytrigger1" onClick="return confirm('Seçili Bilet Makinesi İçin Kiosk Ayarları Silinsin mi?');" role="button"><?php echo $diller["kioskBiletMakinesiSil2"]; ?></a> 
<?php echo $diller["kioskBiletMakinesiMesaj2"]; ?></div>
</div>
</div>
</div>
...
<div class="form-group">
 ...
 <table class="table table-hover">
  <tr>
    <th colspan="2" class="warning"><?php echo $diller['biletYazilari']; ?></th>
    </tr>
  <tr>
    <th colspan="2">Kiosk ID:
    <?php if(isset($_GET['Kiosk'])){ echo "<span class='alert alert-danger'><strong># ".$_GET['Kiosk']." (".$diller['kioskId'].")</strong></span>"; } ?></th>
  </tr>
  <tr>
    <th><?php echo $diller['biletBaslik']; ?> S1:</th>
    <td><span id="sprytextfield1">
      <input class="form-control" maxlength="30" type="text" name="BILET_BASLIK_S1" value="<?php echo htmlentities($row_BiletAyar['BILET_BASLIK_S1'], ENT_COMPAT, 'utf-8'); ?>" required>
      <span class="textfieldRequiredMsg"><?php echo $diller['bosgecilemez']; ?></span></span></td>
  </tr>
  <tr>
    <th><?php echo $diller['biletBaslik']; ?> S2:</th>
  ...
  <tr>
    <th><?php echo $diller['biletBaslik']; ?> S3:</th>
  ...
  <tr>
    <th><?php echo $diller['biletBaslik']; ?> S4:</th>
  ...
  <tr>
    <th><?php echo $diller['yaziTipi']; ?>:</th>
...
?>
  ...
  <tr>
    <th align="right"><?php echo $diller['baslikGosterGizle']; ?> :</th>
...
<table class="table table-hover">
  <tr>
    <th colspan="2" class="success"><?php echo $diller['beklemeYazilari']; ?></th>
    </tr>
  <tr>
    <th><?php echo $diller['etiketBekleyen']; ?>:</th>
    <td><input class="form-control" maxlength="30" type="text" name="ETIKET_BEKLEYEN" value="<?php if($row_BiletAyar['ETIKET_BEKLEYEN']!=""){ echo htmlentities($row_BiletAyar['ETIKET_BEKLEYEN'], ENT_COMPAT, 'utf-8'); }else{ echo $diller['bekleyenKisiSayisi']; }?>" size="32"></td>
  </tr> 
  <tr>
    <th><?php echo $diller['yaziTipi']; ?>:</th>
...
?>
  ...
  <tr>
    <th><?php echo $diller['bekleyenGosterGizle']; ?></th>
  ...
  <tr>
    <th><?php echo $diller['bekleyenSureGosterGizle']; ?></th>
  ...
  <table class="table table-hover">
  <tr>
    <th colspan="2" class="label-red"><?php echo $diller['servisGrupYazilari']; ?></th>
    </tr>
  <tr>
    <th><?php echo $diller['yaziTipi']; ?>:</th>
...
?>
  ...
  <tr>
    <th><?php echo $diller['servisGrupYazilariGosterGizle']; ?>:</th>
...
<table class="table table-hover">
        <tr>
          <th colspan="2" class="label-blue"><?php echo $diller['karsilamaYazilari']; ?></th>
          </tr>
        <tr>
          <th><?php echo $diller['karsilamaYazisi']; ?> 1:</th>
        ...
        <tr>
          <th><?php echo $diller['karsilamaYazisi']; ?> 2:</th>
...
?>
        ...
        <tr>
          <th><?php echo $diller['karsilamaYazisiGosterGizle']; ?>:</th>
        ...
        <table class="table table-hover">
        <tr>
          <th colspan="2" class="label-yellow"><?php echo $diller['biletNumaraYazisi']; ?></th>
          </tr>
        <tr>
          <th><?php echo $diller['yaziTipi']; ?> 1:</th>
...
?>
        ...
        <tr>
          <th><?php echo $diller['yaziTipi']; ?> 2:</th>
...
?>
        ...
        <tr>
          <th><?php echo $diller['biletNumaraYazisiGosterGizle']; ?>:</th>
      ...
      <div class="panel body">
        <table class="table table-hover">
        <tr>
          <th colspan="2" class="label-green"><?php echo $diller['tarihYazisi']; ?></th>
          </tr>
        <tr>
          <th><?php echo $diller['yaziTipi']; ?>:</th>
...
?>
        ...
        <tr>
          <th><?php echo $diller['tarihYazisiGosterGizle']; ?>:</th>
